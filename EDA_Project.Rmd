...
#### Do not run - Google geocode no requires API KEY ###
...
```{r corr_matrix, echo=FALSE, fig.dim = c(10,10), fig.align='center', message=FALSE, warning=FALSE }
...
#### intermittant error  'In stringUnit(units) : reached elapsed time limit'
#### rerun grid.arrange will display HI maps?
...
ggplot(rad_trim, aes(region, fill = ANALYTE_ID)) + 
  geom_bar(stat="count") +
  facet_wrap(~rad_trim$MAT_ID, ncol = 2, scales = 'free_y') +
  theme(legend.key.size = unit(2,"mm"), 
