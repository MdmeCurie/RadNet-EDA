...
knitr::opts_chunk$set(fig.align = 'center', fig.path='Figs/', warning=FALSE, message=FALSE)
```
...
```{r locations, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10}
### City Locations ####
...
#### Do NOT RUNGoogle maps now requires API KEY !!! 
...
img <- readPNG("Maps/usa_stations.png")
 rid.raster(img, width=9, height=7.5, default.units = "in", just = 'center')
```
...
img <- readPNG("Maps/loc_empty_h20.png")
