...
```{r HI_airsamples, echo = FALSE, message=FALSE, warning=FALSE}
...
```{r beta_all_date, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r analyte_region, echo=FALSE, message=FALSE, warning=FALSE}
